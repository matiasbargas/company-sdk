...
**The problem today:**
[What do they do right now without this? What's painful about it?]

**What "solved" looks like:**
[What would the person say or do differently after using this? What's the measurable signal that it worked?]

**What makes this different:**
[Why would someone choose this over what already exists? Even if the answer is "nothing yet," write that — it's honest.]

**What I'm most uncertain about:**
[The riskiest assumption. What has to be true for this to work?]
...
The problem:
[1-2 sentences on the market condition this responds to.]

The user:
[Specific person with a specific problem.]

What we're building:
[What it does. Keep it to 2-3 sentences.]
...
### Technical
- Stack assumptions: [What technology are we likely to use?]
- Integration requirements: [Any external APIs, services, or data sources?]
- Data: [What data does this create or consume? Any PII?]

### Legal / Compliance
- User data involved: [Yes/No — describe if yes]
- Regulated industry: [Yes/No — which regulations if yes?]
- Contract requirements: [Any third-party agreements needed?]

### Financial
- Revenue model: [How does this make money?]
- Cost assumptions: [Any known infrastructure or vendor costs?]
- Budget: [If known]
