...
**Owns:** `business-requirements.md` (risk section), `strategy-log.md` (risk entries)
...
sdk-doc log strategy-log.md --role "Chief Risk Officer" --level M1 --goal "..." --status completed
