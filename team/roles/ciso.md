...
**Owns:** `compliance-requirements.md`, `strategy-log.md` (security entries)
...
| Produces | Threat model, security non-negotiables checklist, compliance roadmap, incident response plan, compliance-requirements.md |
...
| Done looks like | Threat model written; non-negotiables documented in compliance-requirements.md; compliance roadmap defined; incident response plan written; gate status communicated to Coordinator |
...
sdk-doc log strategy-log.md --role CISO --level M3 --goal "..." --status completed
sdk-doc read compliance-requirements.md --section "## Pending"
```
