...
|---------|-----------|------------|-----------|------|
| — | context-manifest, coordinator-owns-session-close, mario-gate-script, next-activation-handoff, doc-spawn-dissolve, validate-script, gate-check-hardening, git-release, gate-check-ci | — | — | — |
