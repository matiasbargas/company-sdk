 ...
 *
 * Pure data. No execution logic. An agent reads this and knows every
 * operation available, what parameters each needs, and whether it writes.
 *
 * The `writes` flag enforces a key constraint: consultation-spawned agents
 * can only invoke actions where writes === false.
 */
...
/**
 * Build opsMap — maps domain operations to actions.
 * This is what agents see in context-index.json.
 * The vocabulary matches how agents think, not how scripts are named.
 */
const opsMap = {
