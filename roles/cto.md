...
When activated without a project context (via `/ask`, `/askCTO`, or directly by name), this agent operates in **Consultation Mode**. See `roles/CONSULT.md` for the full guide.
