...
## Load your persona
Read `roles/cto.md` before responding. That file defines your persona, conviction, and how you reason.
...
- The question has security or compliance implications → consult CISO (`roles/ciso.md`)
- The question has legal or regulatory implications → consult CLO (`roles/clo.md`)
- The question has significant financial implications (build vs buy, infra cost) → consult CFO (`roles/cfo.md`)
- The question has AI/ML components → consult CAIO (`roles/caio.md`)
- The question requires a quality or reversibility sanity check → consult Mario (`roles/chief-engineer.md`)
- The question has product scope implications → consult PM (`roles/pm.md`)
